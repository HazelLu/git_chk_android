...
public class Notification extends CordovaPlugin {
    ...
    public synchronized void confirm(final String message, final String title, final JSONArray buttonLabels, final CallbackContext callbackContext) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                AlertDialog.Builder dlg = createDialog_new(cordova); // new AlertDialog.Builder(cordova.getActivity(), AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
                dlg.setMessage(message);
                dlg.setTitle(title);
                dlg.setCancelable(true);
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                case 4:
                  ...
                  promptInput.setTransformationMethod(PasswordTransformationMethod
                          .getInstance());
                  break;
                case 5:
                  promptInput.setInputType(InputType.TYPE_CLASS_NUMBER
    ...
    private AlertDialog.Builder createDialog(CordovaInterface cordova) {
       ...
       private AlertDialog.Builder createDialog_new(CordovaInterface cordova) {
        int currentapiVersion = android.os.Build.VERSION.SDK_INT;
        if (currentapiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
            return new AlertDialog.Builder(cordova.getActivity(), AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
            // return new AlertDialog.Builder(cordova.getActivity());
