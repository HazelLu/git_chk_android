...
var app = {
    ...
    _messageList:function(v){
        ...
        domStr +='</span></h4>';
        domStr += v.fb_date =='' ? '<p>提交於 '+ v.create_date +' <span>'+v.msg_type+'</span></p>':'<p>最新回覆 '+v.fb_date+' <span>'+v.msg_type+'</span></p>';
    ...
    _feedbackDesc:function(idx){
        ...
        switch(idx){
            ...
            break;
            case 3:
                msg='家中裝潢異常狀況說明。如：家中對講機壞了一週，話筒沒有聲音，請協助查看';
            break;
            case 1:
                msg='公設異常位置及狀況說明。如：三樓韻律教室內有一盞燈不亮';
            break;
            case 2:
                msg='在社區生活中有影響居住品質的情形說明。如：社區門口違規停車';
            break;
            case 4:
                msg='對於提升社區居住品質有任何提案或建議。如：建議社區可以多辦一些活動';
            break;
            case 5:
                msg='針對今網行動管家App使用上有任何問題或其他服務需求，請協助說明，我們將請專人為您服務。如：App可以提供叫車服務嗎?';
            break;
